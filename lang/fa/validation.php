...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'description'        => 'توضیحات',
        'single_price'       => 'قیمت تکی',
        'single_stock'       => 'موجودی تکی',
        'single_min_sale'    => 'تعداد حداقل فروش تکی',
        'major_price'        => 'قیمت عمده',
        'major_stock'        => 'موجودی عمده',
        'major_min_sale'     => 'تعداد حداقل فروش عمده',
        'major_unit_id'      => 'واحد تعداد',
        'delivery_days'      => 'تاریخ تحویل',
        'inventory_status'   => 'وضعیت کالا',
        'current_password'   => 'رمز عبور فعلی',
        'quantity'           => 'تعداد',
        'subject'            => 'موضوع',
        'message'            => 'متن',
        'publication_status' => 'وضعیت',
