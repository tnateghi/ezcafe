...
@section('content')
    <main id="main-container">
        ...
        <div class="content">
            ...
            <form class="ajax-form" action="{{ route('admin.foods.store') }}" data-redirect="{{ route('admin.foods.index') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <!-- Info -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="mb-4">
                                            ...
                                            <input type="number" class="form-control ltr amount-input" id="price" name="price" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="mb-4">
